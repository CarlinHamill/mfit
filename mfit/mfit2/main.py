...
from mfit.mfit2.ui import main_screen_widget_ui, parameter_value_display_widget_ui, set_parameter_widget_ui, application_base_ui, startup_ui, file_input_ui, analysis_ui_widget_ui
from mfit.mfit2.custom_widgets import PageWidget, LayoutWidget
import mfit.mfit2.handlers as handlers
from mfit.mfit2.data_tools import Database
...
class ApplicationWindow(QtWidgets.QMainWindow):
    ...
    def create_handlers(self)->None:
        ...
        self.cpl_edit_handler = handlers.HeatCapacityLowerEditHandler(self)
    ...
    def set_up_sidebar(self):
        ...
        self.parameter_value_widget = LayoutWidget(parameter_value_display_widget_ui, parameter_value_layout)
        self.parameter_start_widget = LayoutWidget(set_parameter_widget_ui,  parameter_start_layout)
...
#     cpl_button = application.main_widget.ui.pushButton_2


class ApplicationSignals(QtCore.QObject):
    show_cpl_signal = QtCore.pyqtSignal(bool)
