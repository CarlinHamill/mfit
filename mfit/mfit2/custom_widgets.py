...
if TYPE_CHECKING:
    from mfit.mfit2.main import ApplicationWindow

#PyQT/Matplotlib Imports
...
class MPLCanvas(FigureCanvas):
    ...
    def add_plot(self, plot_function:typing.Callable, picker=None)->None:
        plot_function(self.axes, picker)
