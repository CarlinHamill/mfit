...
# Form implementation generated from reading ui file 'parameter_value_display_widget2.ui'
#
...
"}")
        ...
        self.enthalpyDifferenceLineEdit.setReadOnly(True)
        self.enthalpyDifferenceLineEdit.setObjectName("enthalpyDifferenceLineEdit")
        self.verticalLayout_5.addWidget(self.enthalpyDifferenceLineEdit)
        ...
        self.heatCapacityLowerLabel = QtWidgets.QLabel(self.widget_4)
        ...
        self.heatCapacityLowerLineEdit = QtWidgets.QLineEdit(self.widget_4)
        ...
        self.verticalLayout_3.addWidget(self.heatCapacityLowerLineEdit)
        self.lineEdit_5 = QtWidgets.QLineEdit(self.widget_4)
        self.lineEdit_5.setMinimumSize(QtCore.QSize(70, 0))
        ...
        self.TcLabel = QtWidgets.QLabel(self.widget_5)
        ...
        self.TcLineEdit = QtWidgets.QLineEdit(self.widget_5)
        ...
        self.verticalLayout_4.addWidget(self.TcLineEdit)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_11.setText(_translate("Form", "Parameter:"))
...
"Error:"))
        ...
        self.enthalpyDifferenceLineEdit.setStatusTip(_translate("Form", "Parameter fit value"))
        self.lineEdit_3.setStatusTip(_translate("Form", "Parameter fit error"))
        ...
        self.heatCapacityLowerLineEdit.setStatusTip(_translate("Form", "Parameter fit value"))
        self.lineEdit_5.setStatusTip(_translate("Form", "Parameter fit error"))
        self.TcLabel.setText(_translate("Form", "Transition Point (T<sub>C</sub>):"))
        self.label_2.setText(_translate("Form", "(K)"))
        self.TcLineEdit.setStatusTip(_translate("Form", "Parameter fit value"))
        self.lineEdit_4.setStatusTip(_translate("Form", "Parameter fit error"))
